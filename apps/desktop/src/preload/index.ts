...
const api = {
  ...
  shell: {
    ...
    terminateForWorktree: (worktreePath: string) => ipcRenderer.invoke('shell:terminate-for-worktree', worktreePath),
  ...
  ide: {
    ...
    open: (ideName: string, worktreePath: string) => ipcRenderer.invoke('ide:open', ideName, worktreePath),
  },
  theme: {
