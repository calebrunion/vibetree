...
describe('TerminalController', () => {
  ...
  describe('handleTerminalClose', () => {
    ...
    it('should call onCleanupError when termination fails', async () => {
      ...
      await expect(controller.handleTerminalClose(event)).rejects.toThrow('Failed to terminate PTY process process-123')
  ...
  describe('handleBatchTerminalClose', () => {
    ...
    it('should handle partial failures in batch close', async () => {
      ...
      await expect(controller.handleBatchTerminalClose(events)).rejects.toThrow('Failed to close 1 terminal(s)')
    ...
    it('should continue closing other terminals even if one fails', async () => {
      ...
      await expect(controller.handleBatchTerminalClose(events)).rejects.toThrow('Failed to close 2 terminal(s)')
