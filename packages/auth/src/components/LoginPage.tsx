    ...
    return (
      <div className={`min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 ${className}`}>
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">No Authentication Required</h2>
          <p className="text-gray-600 dark:text-gray-400">The server is running in open access mode.</p>
        </div>
      </div>
    )
  }
      ...
      <div className={`min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 ${className}`}>
        <div className="max-w-md w-full space-y-8 p-8">
          <div className="text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Server Configuration Error</h2>
